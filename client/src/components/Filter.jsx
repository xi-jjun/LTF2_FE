...
import { Accordion , AccordionSummary, AccordionDetails , Typography, FormControl, RadioGroup, FormControlLabel, Radio } from '@mui/material'
...
export default function Filter(){
    ...
    const Label = ({text}) => {
        return (
            <Styles.OptionText>{text}</Styles.OptionText>
        )
    }
